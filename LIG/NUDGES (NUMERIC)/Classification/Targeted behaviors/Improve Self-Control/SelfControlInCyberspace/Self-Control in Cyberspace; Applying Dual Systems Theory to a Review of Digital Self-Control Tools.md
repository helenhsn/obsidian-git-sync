...
|       | **[[LIG/NUDGES (NUMERIC)/Classification/Type of nudges/Nudges found/MyTime]]**, an Android app showing time spent in apps (and whether a daily limit was hit) plus a daily prompt asking what the user wished to achieve | *None*                                                                                     |
